             ...
             <div class="eat"> 
                 <ul class="eat__list-food">
                     <li class="eat__item-food">
                         <a href="script_chien(pnhi)/chien1.html" class="eat__item-food-link">
                             <img src="https://i.ytimg.com/vi/1tjlL643E0M/maxresdefault.jpg" alt="Cánh gà sốt me cay" class="food-link-img">
                         </a>
                         <span class="food-link-text">
                            <bold>Cánh gà sốt me cay</bold>
                         </span>
                     </li>
                     <li class="eat__item-food">
                         <a href="script_chien(pnhi)/chien2.html" class="eat__item-food-link">
                             <img src="https://dauhomemade.vn/apps/uploads/2018/09/B%C3%A1nh-t%C3%B4m-h%E1%BB%93-T%C3%A2y-68000-4096x2731.jpg" alt="Takoyaki" class="food-link-img">
                         </a>
                         <span class="food-link-text">
                             <bold>Bánh tôm Hồ Tây</bold>
                         </span>
                     </li>
                     <li class="eat__item-food">
                         <a href="script_chien(pnhi)/chien3.html" class="eat__item-food-link">
                             <img src="https://gcs.tripi.vn/public-tripi/tripi-feed/img/473888KPU/nem-ca-lang-4.jpg" alt="Nem cá" class="food-link-img">
                         </a>
                         <span class="food-link-text">
                             <bold>Nem cá</bold>
                         </span>
