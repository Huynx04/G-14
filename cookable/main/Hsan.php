...
<!-- top -->
    <div id = "top">     
        <div class="fl">  <h1> Hải sản</h1></div>
    ...
    <div class="eat"> 
        <ul class="eat__list-food">
            <li class="eat__item-food">
                <a href="scr_haisan(pnhi)/hsan1.html" class="eat__item-food-link">
                    <img src="https://statics.vinwonders.com/banh-da-cua-hai-phong-o-ha-noi-1_1687012182.jpg" alt="bánh đa cua" class="food-link-img">
                </a>
                <span class="food-link-text">
                   <bold> Bánh đa cua Hải Phòng</bold>
                </span>
            </li>
            <li class="eat__item-food">
                <a href="scr_haisan(pnhi)/hsan2.html" class="eat__item-food-link">
                    <img src="https://static.vinwonders.com/production/bun-oc-nguoi-ha-noi-1.jpg" alt="bún ốc nguội" class="food-link-img">
                </a>
                <span class="food-link-text">
                    <bold>Bún ốc nguội</bold>
                </span>
            </li>
            <li class="eat__item-food">
                <a href="scr_haisan(pnhi)/hsan3.html" class="eat__item-food-link">
                    <img src="https://syphu.com.vn/wp-content/uploads/2022/11/lam-lau-cua-dong.jpg" alt="Lẩu riêu cua" class="food-link-img">
                </a>
                <span class="food-link-text">
                    <bold>Lẩu riêu cua bắp bò</bold>
                </span>
            </li>
        </ul>
    </div>
