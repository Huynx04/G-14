             ...
             <div class="eat"> 
                 <ul class="eat__list-food">
                     <li class="eat__item-food">
                         <a href="scr_giacam(pnhi)/gia_cam1.html" class="eat__item-food-link">
                             <img src="https://i.ytimg.com/vi/aScvYvQCadg/maxresdefault.jpg" alt="cánh gà nướng cay kiểu Hàn" class="food-link-img">
                         </a>
                         <span class="food-link-text">
                            <bold> Cánh gà nướng cay kiểu Hàn</bold>
                         </span>
                     </li>
                     <li class="eat__item-food">
                         <a href="scr_giacam(pnhi)/gia_cam2.html" class="eat__item-food-link">
                             <img src="https://heoquaydachoa.com/wp-content/uploads/2022/12/Vit-Quay-Mat-Ong-Dac-Hoa-1200x900-1.jpg" alt="vịt quay" class="food-link-img">
                         </a>
                         <span class="food-link-text">
                             <bold>Vịt quay mật ong da giòn</bold>
                         </span>
                     </li>
                     <li class="eat__item-food">
                         <a href="scr_giacam(pnhi)/gia_cam3.html" class="eat__item-food-link">
                             <img src="https://daotaobeptruong.vn/wp-content/uploads/2020/11/ga-xao-hung-que.jpg" alt="mề gà xào" class="food-link-img">
                         </a>
                         <span class="food-link-text">
                             <bold>Mề gà xào húng quế</bold>
                         </span>
                     </li>
                 </ul>
             </div>
